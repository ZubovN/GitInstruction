...
Устанавливаем с настройками по уssмолчанию.
=======
Загружаем послднюю версию asfGit с [сайта](https://git-scm.com/download) 
 с настроssйкамиas f ssмолчанию Устанавливаем по у.
>>>>>>> InstallingGit
## 3. настройка Git 
